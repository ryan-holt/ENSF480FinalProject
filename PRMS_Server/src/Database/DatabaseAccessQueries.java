...
/**
 * This interface stores the SQL queries that are executed in the database model.
 */
public interface DatabaseAccessQueries {
    ...
    static final String SQL_ADD_LISTING = "INSERT INTO listings (bedrooms, bathrooms, type, quadrant, furnished, state, fee, landlordEmail, listingID, creationDate, address) values(?,?,?,?,?,?,?,?,?,?,?)";
